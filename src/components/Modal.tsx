...
export default function Modal({
  ...
  return (
    <>
      ...
      {open &&
        // Portal a document.body: así el modal no hereda transparencia ni otros efectos visuales
        // (ej. opacity-60 de una tarjeta archivada/saldada) del contenedor donde vive el botón.
        createPortal(
