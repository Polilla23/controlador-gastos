      ...
      <div className="w-full max-w-sm">
        ...
        <div className="card">
          <div className="mb-4 grid grid-cols-2 gap-1 rounded-xl bg-gray-100 p-1 text-sm font-semibold">
            <button type="button" onClick={() => setMode("in")} className={`rounded-lg py-1.5 ${mode === "in" ? "bg-white shadow" : "text-gray-500"}`}>
              Iniciar sesión
            </button>
            <button type="button" onClick={() => setMode("up")} className={`rounded-lg py-1.5 ${mode === "up" ? "bg-white shadow" : "text-gray-500"}`}>
              Crear cuenta
            </button>
          </div>
